...
const MOBILE_NAV_ITEMS_AUTOPILOT = [
  { label: 'Dashboard',  href: '/dashboard'       },
  { label: 'Invoices',   href: '/invoices'        },
  { label: 'Payslips',   href: '/payslip-history' },
  { label: 'SAB Chat',   href: '/chat'            },
  { label: 'Settings',   href: '/settings'        },
]
...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const mobileNavItems = profile.plan === 'autopilot' ? MOBILE_NAV_ITEMS_AUTOPILOT : MOBILE_NAV_ITEMS_DEFAULT
                ...
                {!FREE_MODE && <span
                  ...
                  title={
                    profile.plan === 'autopilot'
                      ? 'Autopilot plan — SAB Chat, PAYG payslips, and all features unlocked'
                      : profile.plan === 'pro'
                      ? 'Pro plan — payslips, PAYG, and super calculations included'
                      : profile.plan === 'starter'
                      ? 'Starter plan — unlimited invoices'
                      : 'Free plan — upgrade for payslips and unlimited invoices'
                  }
                  style={{
                    fontSize: '0.6875rem',
                    fontWeight: 700,
