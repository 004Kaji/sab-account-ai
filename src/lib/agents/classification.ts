...
export const AGENT_KEYWORDS: Record<QuestionClass, string[]> = {
  ...
  PERSONAL: [
    'my visa', 'student visa', 'permanent residency', 'pr visa', 'visa expiry',
    'my university', 'my course', 'my assignment', 'my semester', 'uni fee',
    'my goals', 'my dream', 'north star', 'my north star',
    'i am tired', 'i am overwhelmed', 'feeling stressed', 'what do i do next',
    'who are you', 'what can you do', 'your name', 'introduce yourself',
    'find me a job', 'job in darwin', 'job in sydney', 'job in melbourne',
    'find me work', 'casual work', 'part time work', 'internship in',
    'weather in', 'weather today', 'weather tomorrow',
    'my budget', 'my income', 'my expenses', 'my spending',
    'web search', 'search for', 'look up online', 'look it up',
    'my resume', 'my cv', 'apply for job',
  ],
  STRATEGY: [
  ...
  AGENT_STATUS: [
    ...
    'what is basnet', 'what are your agents',
